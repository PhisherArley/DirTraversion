...
void PrintDirFirst_enUS(LPTSTR currPath, int files) {
    int i;
    strtok(currPath, "*");
    printf("\n%s\n\n", currPath);
...
void PrintFileInfo_enUS(LPTSTR currPath, int files) {
    int i;
    strtok(currPath, "*");
    printf("\n%s\n\n", currPath);
...
void PrintThousandFormat_enUS(LPTSTR currPath, int files, LPTSTR option) {
    int i;
    strtok(currPath, "*");
    printf("\n%s\n\n", currPath);
...
void PrintSortedFile_enUS(LPTSTR currPath, int files) {
    int i, j;
...
void PrintShortName_enUS(LPTSTR currPath, int files) {
    int i;
    int length = 0;
    TCHAR *buffer = NULL;
    strtok(currPath, "*");
...
void PrintFileOwner_enUS(LPTSTR currPath, int files) {
    int i;
    strtok(currPath, "*");
    printf("\n%s\n\n", currPath);
